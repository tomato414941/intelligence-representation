...
class ShogiMoveEncodingTest(unittest.TestCase):
    ...
    def test_legal_move_features_are_padded_to_max_legal_move_count(self) -> None:
        ...
        self.assertEqual(tuple(features.shape), (4, SHOGI_MOVE_FIELD_COUNT))
        self.assertTrue(torch.equal(features[2], torch.zeros(SHOGI_MOVE_FIELD_COUNT, dtype=torch.long)))
