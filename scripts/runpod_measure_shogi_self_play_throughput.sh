...
CHECKPOINT = INTREP / 'models/d256-h1024-heads8-l6-shogi/checkpoint'
...
CASE_SETS = {
    ...
    'leaffill': [
        ('w6_c8_s16_b32_g48_l4', 48, 8, 6, 16, 32),
        ('w6_c8_s16_b64_g48_l4', 48, 8, 6, 16, 64),
        ('w6_c16_s16_b32_g96', 96, 16, 6, 16, 32),
        ('w6_c16_s16_b64_g96', 96, 16, 6, 16, 64),
    ],
}
try:
