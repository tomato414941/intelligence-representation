...
def run_case(
    ...
    command = [
        ...
        '--black-checkpoint-simulations', str(simulations),
        '--black-checkpoint-evaluation-batch-size', str(batch),
        '--black-checkpoint-device', 'cuda',
        '--black-checkpoint-board-backend', 'cshogi',
        '--white-kind', 'checkpoint',
        '--white-checkpoint', str(CHECKPOINT),
        '--white-checkpoint-profile', 'self-play',
        '--white-checkpoint-policy', 'mcts',
        '--white-checkpoint-simulations', str(simulations),
        '--white-checkpoint-evaluation-batch-size', str(batch),
        '--white-checkpoint-device', 'cuda',
        '--white-checkpoint-board-backend', 'cshogi',
    ]
