...
from intrep.worlds.shogi.training_view import create_shogi_training_view, parse_shogi_actor_pair_ratios


def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Create a fixed shogi training view from train/eval game logs.")
