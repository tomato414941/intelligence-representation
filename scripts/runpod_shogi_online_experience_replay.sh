...
GENERATION_WORKER_PROCESSES=${GENERATION_WORKER_PROCESSES:-32}
...
CHECKPOINT_MOVE_SELECTION_PROFILE=${CHECKPOINT_MOVE_SELECTION_PROFILE:-self-play}
...
SAMPLED_EXAMPLES_PER_ITERATION=${SAMPLED_EXAMPLES_PER_ITERATION:-32768}
...
GENERATOR_GATE_WORKER_PROCESSES=${GENERATOR_GATE_WORKER_PROCESSES:-32}
