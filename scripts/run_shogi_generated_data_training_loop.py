...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run repeated generated shogi data training cycles.")
    ...
    parser.add_argument("--nn-leaf-eval-batch-limit", type=int, default=1)
