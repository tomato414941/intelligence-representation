...
| Qhapaq processed data | The local source-derived records are `data/qhapaq/processed/qhapaq_all_games.jsonl`; train/eval splits belong in Data Selection or fixed training views, not in `processed/`. |
