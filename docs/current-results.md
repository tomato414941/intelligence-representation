...
details remain under `legacy/docs/`.
...
- [Legacy Experiment 001](../legacy/docs/experiments/experiment-001.md): retired Signal future-prediction run
- [Legacy Experiment 002](../legacy/docs/experiments/experiment-002.md): retired rendering-context investigation
- [Legacy Experiment 003](../legacy/docs/experiments/experiment-003.md): natural language held-out loss smoke check
