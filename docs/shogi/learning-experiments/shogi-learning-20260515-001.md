# Shogi Learning Experiment 20260515-001

This document records details for one shogi learning experiment. It is not a
complete run log and it does not treat `runs/` as a durable source of truth.

## Summary

| Experiment | Date | Method | Starting checkpoint ID | Starting checkpoint path | Next-cycle checkpoint | Cycles | Remote job wall time |
| --- | --- | --- | --- | --- | --- | ---: | ---: |
| `shogi-learning-20260515-001` | 2026-05-15 | online replay | not recorded | `models/d256-h1024-heads8-l6-shogi/checkpoint.pt` | cycle final checkpoint | 4 | 42.9 min |
...
## Cycle Experience Sources

| Experiment | Cycle | Source | Games | Checkpoint input | Side assignment | Opponent | Seed | Notes |
| --- | ---: | --- | ---: | --- | --- | --- | ---: | --- |
| `shogi-learning-20260515-001` | 1 | self-play | 64 | starting checkpoint | checkpoint black / checkpoint white | same checkpoint | 7 | current checkpoint on both sides |
| `shogi-learning-20260515-001` | 1 | checkpoint-vs-USI | 64 | starting checkpoint | checkpoint black / USI white | YaneuraOu | 8 | fixed-side USI generation |
| `shogi-learning-20260515-001` | 2 | self-play | 64 | cycle 1 final checkpoint | checkpoint black / checkpoint white | same checkpoint | 10007 | current checkpoint on both sides |
| `shogi-learning-20260515-001` | 2 | checkpoint-vs-USI | 64 | cycle 1 final checkpoint | checkpoint black / USI white | YaneuraOu | 10008 | fixed-side USI generation |
| `shogi-learning-20260515-001` | 3 | self-play | 64 | cycle 2 final checkpoint | checkpoint black / checkpoint white | same checkpoint | 20007 | current checkpoint on both sides |
| `shogi-learning-20260515-001` | 3 | checkpoint-vs-USI | 64 | cycle 2 final checkpoint | checkpoint black / USI white | YaneuraOu | 20008 | fixed-side USI generation |
| `shogi-learning-20260515-001` | 4 | self-play | 64 | cycle 3 final checkpoint | checkpoint black / checkpoint white | same checkpoint | 30007 | current checkpoint on both sides |
| `shogi-learning-20260515-001` | 4 | checkpoint-vs-USI | 64 | cycle 3 final checkpoint | checkpoint black / USI white | YaneuraOu | 30008 | fixed-side USI generation |
...
| --- | --- | ---: | --- | ---: | ---: | ---: | ---: | --- | ---: |
| `shogi-learning-20260515-001` | `data/shogi/training-data-bundles/online-replay-seed-20260512/data-selection.json` | 17,644 | eval split from same data-selection artifact | 5,967 | 512 | 65,992 | 3,473 | fixed eval, not generated eval | 83,636 |
...
| Experiment | Source | Games | Average plies | Black wins | White wins | Max-plies endings | Generated train examples |
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: |
| `shogi-learning-20260515-001` | self-play | 256 | 220.7 | 63 | 84 | 109 | included in 65,992 total |
| `shogi-learning-20260515-001` | checkpoint-vs-USI | 256 | 50.6 | 0 | 256 | 0 | included in 65,992 total |

## Generation Runtime Observations
...
| Experiment | Evidence | Initial checkpoint | Trained checkpoint | Result | Conclusion |
| --- | --- | ---: | ---: | --- | --- |
