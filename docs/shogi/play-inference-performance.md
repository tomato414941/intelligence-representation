...
| --- | --- | --- | --- | --- | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- | --- |
| `rtx4000ada_mcts1024_b64` | 2026-05-13 | d256-h1024-heads8-l6-shogi | RTX 4000 Ada | 5 vCPU, 47 GB | not recorded | not recorded | $0.20/hr | 1024 | 64 | not measured | not measured | 9.0s | 1 | 1.625s | 3.619s | 4.862s | 27.906 | 1.324s | 0.301s | 764.8 | 53 | 19.3% | 30.6% | 8.3% | 16.0% | 1602 MiB | 0-1, game_over, 64 plies | Stayed below 10s with margin; low GPU utilization means the measured model wall time does not imply GPU saturation. |
| `rtx4000ada_mcts2048_b64` | 2026-05-13 | d256-h1024-heads8-l6-shogi | RTX 4000 Ada | 5 vCPU, 47 GB | not recorded | not recorded | $0.20/hr | 2048 | 64 | not measured | not measured | 9.0s | 1 | 2.944s | 3.995s | 6.715s | 45.192 | 2.421s | 0.523s | 742.1 | 76 | 18.4% | 32.2% | 8.9% | 16.0% | 1138 MiB | 0-1, game_over, 52 plies | Stayed below 10s in this one-game check; GPU utilization remained low, so increasing simulations mostly increases serialized work rather than saturating the GPU. |
