...
| `shogi-action-plane-policy-output-dlshogi-like-no-entering-king` | dlshogi-style current-position piece, hand, check, and attack features; no entering-king features. | implemented |
