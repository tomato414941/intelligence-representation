...
| `minimal_split_global_action_plane_rtx3090_b512_100k_fr` | 2026-05-22 | shogi-policy-plane-minimal-split-global | RTX 3090 | 8 vCPU / 30 GiB | community | FR | $0.22/hr | Qhapaq full packed tensor cache | action-plane policy/value | 512 | 100000 | 1000 steps | 1000 steps | 2 | 2,085,103,500 bytes | about 53s | pending | pending | pending | pending | pending | pending | pending | pending | pending | pending | Full training run started as `full-minimal-split-global-b512-20260522-183121`; metrics will be filled after completion. |
