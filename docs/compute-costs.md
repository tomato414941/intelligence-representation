...
| 2026-05-04 | candidate-aware value-only smoke EU | estimated | RunPod RTX 4090, $0.69/hr | d256-h1024-heads8-layers6 | Qhapaq split cache | 1000 | 512 | about 6-8m total | about $0.07-$0.09 | policy_loss_weight=0.0; value_loss_weight=1.0; estimate from recent policy-only smoke. |
