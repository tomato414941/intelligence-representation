...
| 2026-05-03 | policy-only full-cache baseline workers0 EU | measured | RunPod RTX 4090, $0.69/hr | d256-h1024-heads8-layers6 | Qhapaq shogi move-choice train/eval cache | 2000 | 512 | 11m20s total, 8m25s training | about $0.13 | Passed on `EU-RO-1` with 61 GB RAM and `NUM_WORKERS=0`. Training throughput was 3.96 steps/s and CUDA max memory was about 8.1 GB. Eval accuracy improved from 0.0364 to 0.1191, eval top-5 accuracy reached 0.3977, and eval MRR reached 0.2567. |
...
The workers0 EU run completed and produced metrics/checkpoint. For longer runs,
prefer `EU-RO-1` and keep `NUM_WORKERS=0` until the full Python-object cache is
replaced or DataLoader memory behavior is improved.
