...
| 2026-05-04 | candidate-aware value-only policy-skip comparison EU | estimated | RunPod RTX 4090, $0.69/hr | d256-h1024-heads8-layers6 | Qhapaq split cache | 3000 | 512 | about 14-16m total | about $0.16-$0.19 | policy_loss_weight=0.0; value_loss_weight=1.0; estimate from recent value-only policy-skip smoke. |
