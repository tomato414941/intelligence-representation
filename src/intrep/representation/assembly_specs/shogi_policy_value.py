...
SHOGI_POLICY_VALUE_DLSHOGI_LIKE_POLICY_PLANE_ASSEMBLY_SPEC_ID = (
    "shogi_policy_value_dlshogi_like_position_transformer_policy_plane"
)
SHOGI_POLICY_VALUE_MINIMAL_SINGLE_GLOBAL_POLICY_PLANE_ASSEMBLY_SPEC_ID = (
    "shogi_policy_value_minimal_single_global_position_transformer_policy_plane"
)
SHOGI_POLICY_VALUE_MINIMAL_SPLIT_GLOBAL_POLICY_PLANE_ASSEMBLY_SPEC_ID = (
    "shogi_policy_value_minimal_split_global_position_transformer_policy_plane"
)
