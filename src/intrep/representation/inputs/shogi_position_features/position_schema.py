...
PIECE_SLOT_COUNT = 40
COUNTERFACTUAL_FIELD_COUNT = 3
DROP_POTENTIAL_FIELD_COUNT = 2
PIECE_FIELD_COUNT = 5 + COUNTERFACTUAL_FIELD_COUNT + DROP_POTENTIAL_FIELD_COUNT
...
def shogi_rich_position_feature_manifest() -> dict[str, object]:
    return {
        ...
        "square_field_count": SHOGI_RICH_POSITION_SQUARE_FIELD_COUNT,
        "piece_field_count": SHOGI_RICH_POSITION_PIECE_FIELD_COUNT,
        "line_field_count": SHOGI_RICH_POSITION_LINE_FIELD_COUNT,
