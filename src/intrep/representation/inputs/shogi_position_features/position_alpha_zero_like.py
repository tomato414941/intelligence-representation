...
from intrep.representation.inputs.shogi_position_features.position_sfen import (
    ...
    shogi_current_square_piece_plane_feature_id_rows_from_sfen,
...
SHOGI_ALPHA_ZERO_LIKE_SQUARE_FIELD_COUNT = 28
...
def shogi_alpha_zero_like_position_feature_manifest() -> dict[str, object]:
    return {
        ...
        "square_field_count": SHOGI_ALPHA_ZERO_LIKE_SQUARE_FIELD_COUNT,
...
def shogi_alpha_zero_like_position_features_from_sfen(position_sfen: str) -> ShogiPositionFeatures:
    ...
    return ShogiPositionFeatures(
        ...
        square_feature_ids=torch.tensor(
            shogi_current_square_piece_plane_feature_id_rows_from_sfen(board_sfen, own_is_black=own_is_black),
            dtype=torch.long,
        ),
...
def validate_shogi_alpha_zero_like_position_feature_structure(features: ShogiPositionFeatures) -> None:
    ...
    validate_integer_tensor_shape(
        ...
        (SHOGI_ALPHA_ZERO_LIKE_SQUARE_ELEMENT_COUNT, SHOGI_ALPHA_ZERO_LIKE_SQUARE_FIELD_COUNT),
    )
