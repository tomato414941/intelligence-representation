...
The default benchmark compares a hand-written rule baseline with a frequency-based transition predictor, then checks whether an unsupported case can be corrected by adding the prediction error to training memory.
